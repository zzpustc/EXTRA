...
common_parser.add_argument(
    "--method", type=str, default='ls', choices=list(METHODS.keys()), help="MTL weight method"
)
...
common_parser.add_argument("--wd", type=float, default=1.e-5, help="weight decay")
common_parser.add_argument("--regular", type=bool, default=False, help="whether to regularize")
